...
//owner = 0x13b272d3998Dd82116bDbb972A92A95ddbFC06De
//liquidityBank = 0xCB4f1E557B50Fdd2858A5607432429D5D2575437
...
contract Iguma is Context, IBEP20, Ownable {
    ...
    constructor (address _owner, address _liquidityBank) Ownable(_owner) {
        ...
        _totalSupply = 7_900_000_000 * 10 ** uint256(decimals());
        _name = "Digital Human token";
        _symbol = "IGUMA";
